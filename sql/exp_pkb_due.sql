...
*/
  ...
  AS
    ...
    SELECT fatura_id
         ...
         , nf_nr_linha_due
         , exp_pkg_due.fnc_ind_due('EX0020_NF' ,'L', fatura_id, NULL, fatura_item_id)                                          descricao_comercial
...
/*
  ...
  IS
  SELECT to_char(rcr.processo_numero) processo_numero
  ...
  UNION
 SELECT to_char(rat.processo_numero) processo_numero
...
--              END LOOP;
      ...
      IF(vb_continuar) THEN
        ...
        , last_updated_by                              --14
        , financedvalue                                --15
        , cmmdty_commercial_descr                         --16
        , cmmdty_gs_umed_com                              --17
        , cmmdty_gs_tariff                                --18
        , cmmdty_gs_tariff_est                            --20
        ) VALUES (
                   pn_due_id                           --01
                 , pn_due_ship_id                      --02
                 ...
                 , x.descricao_comercial                  --16
                 , x.descr_un_com                         --17
                 , x.qtde_comercial                       --18
                 , vn_qtde_estatistica                    --20
                 );
