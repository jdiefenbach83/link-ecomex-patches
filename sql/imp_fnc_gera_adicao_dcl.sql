PROMPT CREATE OR REPLACE FUNCTION imp_fnc_gera_adicao_dcl
CREATE OR REPLACE FUNCTION imp_fnc_gera_adicao_dcl
                          ...
                          , pc_aliq_adval_igual_red        VARCHAR2 DEFAULT 'N'  /* 100*/
                          , pn_ato_legal_antd_id           NUMBER   DEFAULT NULL /* 101 */
                          , pn_orgao_emissor_antd_id       NUMBER   DEFAULT NULL /* 102 */
                          , pn_nr_ato_legal_antd           NUMBER   DEFAULT NULL /* 103 */
                          , pn_ano_ato_legal_antd          NUMBER   DEFAULT NULL /* 104 */
                          ) RETURN NUMBER AS
  ...
  vn_ato_legal_antd_id        NUMBER;
  vn_orgao_emissor_antd_id    NUMBER;
  vn_nr_ato_legal_antd        NUMBER;
  vn_ano_ato_legal_antd       NUMBER;
...
*/
  ...
  ELSIF ((vn_qtde_linhas_adi = 80) OR (nvl(vn_qtde_linhas_adi,0) = 0) ) THEN
    ...
    IF (pn_ex_antd_id IS NOT null) THEN
      ...
      vn_ato_legal_antd_id      :=  vcur_ex6.ato_legal_id;
      vn_orgao_emissor_antd_id  :=  vcur_ex6.orgao_emissor_id;
      vn_nr_ato_legal_antd      :=  vcur_ex6.nr_ato_legal;
      vn_ano_ato_legal_antd     :=  vcur_ex6.ano_ato_legal;



    ELSE
      vn_ato_legal_antd_id        := pn_ato_legal_antd_id;
      vn_orgao_emissor_antd_id    := pn_orgao_emissor_antd_id;
      vn_nr_ato_legal_antd        := pn_nr_ato_legal_antd;
      vn_ano_ato_legal_antd       := pn_ano_ato_legal_antd;
    ...
    IF pc_aliq_adval_igual_red = 'S' THEN
        vn_aliq_ii_dev := vn_aliq_ii_red;
    END IF;
    ...
    */
    ...
    INSERT INTO imp_declaracoes_adi
        ...
        VALUES( /* 001 */ pn_declaracao_id
              ...
              , /* 078 */ pn_ex_antd_id
              , /* 079 */ vn_ato_legal_antd_id      --vcur_ex6.ato_legal_id
              , /* 080 */ vn_orgao_emissor_antd_id  --vcur_ex6.orgao_emissor_id
              , /* 081 */ vn_nr_ato_legal_antd      --vcur_ex6.nr_ato_legal
              , /* 082 */ vn_ano_ato_legal_antd     --vcur_ex6.ano_ato_legal
